=== infoGeniuz Form Analytics for cforms II ===
Contributors: infogeniuz
Donate link: http://www.infogeniuz.com/donate/
Tags:  cform, contact, contact form, feedback, form, forms, referring url, analytics, source, medium, browser version, leads, geolocation, state, country, google analytics
Requires at least: 2.9
Tested up to: 3.2.1
Stable tag: 1.1

Add number of visits & pageviews, browser & geolocation data to all your cformsII email notifications.

== Description ==

Enhance cforms II plugin with hidden data that can now be added to each and every lead filling out your online form using cform II.

infoGeniuz will allow you to start collecting intelligent marketing and sales information about the people that are filling out your forms on your website - without asking! Adds Google Analytics data, Time data (paid version only), Hardware data and Geolocation data to your form email notifications so you really know your leads - without asking.

*You must have cforms II plugin installed and this has been tested up to 12.2. Other versions have not been tested, but may function properly.*
...
**Upgrade for only $19.95 for a Limited Time!**
...
1. Unzip and Upload `infoGeniuz_Form_Analytics_for_cform-ii.zip` to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. You will see the results from the plugin in the email notifications from cform.
...
It’s like getting a sneak peak into how folks get to your website and what they do while they’re there.

== Upgrade Notice ==

= 1.1 =
Upgrade to paid version for only $19.95 limited time. infoGeniuz [(http://www.infogeniuz.com/products/wp-plugins/)](http://www.infogeniuz.com/products/wp-plugins/)

== Screenshots ==

1. Email Notification Before Adding this plugin and using cforms II
2. Email Notification After Adding the FREE infoGeniuz plugin and using cforms II
3. Email Notification After Adding the PAID infoGeniuz plugin and using cforms II
